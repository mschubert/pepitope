...
* [`sarek`](https://nf-co.re/sarek/) for variant calling using HaplotypeCaller and Mutect2
* [`rnaseq`](https://nf-co.re/rnaseq/) for RNA-seq quantification using STAR and Salmon
